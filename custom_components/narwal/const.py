...
# (sentence case, as HA shows fan_speed values directly). Full five-tier models
# order enum 4 below enum 5, so Ultra is below Super.
_FAN_SPEED_CANONICAL: dict[str, FanLevel] = {
    "Quiet": FanLevel.MUTE,
    "Standard": FanLevel.NORMAL,
    "Strong": FanLevel.STRONG,
    "Ultra": FanLevel.DEEP,
    "Super": FanLevel.SUPER,
}
...
# 4 (DEEP), exposed as "Super" for those models.
...
_FAN_SPEED_ALIASES: dict[str, FanLevel] = {
    "Super powerful": FanLevel.SUPER,
    "Ultra powerful": FanLevel.DEEP,
    "quiet": FanLevel.MUTE,
